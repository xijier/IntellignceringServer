...
public class PhoneMessage {
    ...
    static final String accessKeyId = "LTAIzb0ZjF5F1xVc";  
    static final String accessKeySecret = "2NbRaOmVfnwwSU30VvXzWy6FQi1fzR";
    public static SendSmsResponse sendSms(String phoneNumber,String code) throws ClientException {  
        ...
        //必填:短信签名-可在短信控制台中找到  
        request.setSignName("智环科技");  
        //必填:短信模板-可在短信控制台中找到  
        request.setTemplateCode("SMS_117526544");  
